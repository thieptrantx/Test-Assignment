...
public function search($params, $export = false) {
    ...
    // filter by helper
    ModelSearchHelper::filterUser($query, 't.updated_by', $this->updated_by);
    ModelSearchHelper::filterDatetime($query, 't.updated_at', $this->updated_at);
    ModelSearchHelper::filterParent($query, 't.parent_id', 'p.name', $this->parent_name);
