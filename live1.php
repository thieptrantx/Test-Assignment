...
<ul>
	<li>1. Write a mysql query to find all the contents (title or content) matching the keyword "Computer on Module" are published (1), order by updated_at, limit 100 records.</li>
	<li>2. Write a mysql query to find all the contents  matching the category "CPU" are published (1), order by updated_at, limit 100 records.</li>
